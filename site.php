...
$app->post("/checkout", function()
{
	...
	switch((int)$_POST['payment-method']){
		...
		break;
		case 2:
			header("Location: /order/".$order->getidorder()."/payment-paypal");
		break;
...
$app->get("/order/:idorder/payment-paypal", function($idorder){
...
$app->post("/register", function(){
	...
	if (User::checkLoginExist($_POST['email']) === true){
		User::setErrorRegister("Este endereço de email esta sendo usado por outro usuário.");
		header('Location: /login');
		exit;
	}
...
$app->post("/profile", function ()
{
	...
	if($_POST['desemail'] != $user->getdesemail())
	{
		...
		{
			User::setError("Este endereçode e-mail já esta cadastrado.");
			header('Location: /profile');
			exit;
		}
	}
